...
const FileUpload = () => {
    ...
    /*
    const handleFileChangeError = ( e ) => (

        // if the user has already uploaded the file, then show an error message
        setErrorMessage( 'You have already uploaded this file.' )

    ) // end of handleFileChangeError
    */
    ...
    const handleSubmit = async ( e ) => {
        ...
        // we need to indicate in the headers the content type or multipart/form-data in our case
        // and let's create a config object to help us do that and we need to the create the
        // onUploadProgress key value pair

        // replace the config below with the second config below
        /*
        const config = {
            headers : {
        ...
        */
        ...
        try {
            ...
            // the forth argument is the onUploadProgress function
    ...
    // I tested the handleSubmit function and everything is working as expected

    // now let's show the image after we upload the image and to do that let's go to 4 -
    // below

    // now let's set an alert message in 5 - above

    // go to 6 - to add the progress bar
    ...
    return (
        ...
        <Fragment>            
            ...
            <div className="file-upload-container">
                ...
                <h1 className="file-upload-container-h1">Upload File</h1>

                { /* form */ /* }
                <form className="file-upload-container--form" noValidate="novalidate" onSubmit={ handleSubmit } >

                    { /* input field - file */ /* }
                    <div className="file-upload-container--form--file-input-container">
                        <input
                    ...
                    { /* submit button */ /* }
                    <div className="file-upload-container--form--button-container">
                        <button
                            type="submit"
                        >
                            Upload
                ...
                { 
                    uploadedFile ? (
                        ...
                        <div className="file-upload-container--file">
