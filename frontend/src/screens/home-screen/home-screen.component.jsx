...
// let's create a new folder in the components folder called file-upload and then create
// 2 new files inside this folder: file-upload.components.jsx and file-upload.styles.scss
// and let's go to the file-upload.components.jsx 1 - file now
